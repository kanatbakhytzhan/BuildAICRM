...
- **Если вебхук вызывается, но reply всегда null** — в логах админки смотреть «ChatFlow: ошибка AI» или «нет ни одной стадии воронки»; проверить, что в теле запроса есть текст и номер в одном из поддерживаемых форматов (в логе «ChatFlow webhook received» видно полное тело).
